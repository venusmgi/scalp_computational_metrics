...
% - Calc_Amplitude_Range: Calculates the amplitude range of the EEG data.
...
headerName = 'clipped_hdr';  % Variable name for EEG header in .mat files
...
for p = 1:length(phase)
    ...
    for f = 1:length(fileNames)
        ...
        artifactalIndecies = false(1,length(rerefEEG));
    ...
    eegMetricFilename = sprintf('%s_results.mat', phase{p});
